...
public class DataStore {
    ...
    /**
    * Update the vote count based on an upvote occuring
    *
    * @id The invidual id for each message (Primary Key)
    * @message The content of the message
    */
    public synchronized DataRow upvoteOne(int id, String message) {
    ...
    /**
    * Downvote the vote count based on an upvote occuring
    *
    * @id The invidual id for each message (Primary Key)
    * @message The content of the message
    */

    public synchronized DataRow downvoteOne(int id, String message) {
       // Do not update if we don't have valid data
        if (id <= 0 || message == null)
          return null;
        // Only update if the current entry is valid (not null)
